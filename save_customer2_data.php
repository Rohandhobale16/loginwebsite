...
$createTableSql = "CREATE TABLE IF NOT EXISTS customer2 (
    OrderDate DATE,
    Company VARCHAR(50),
    Owner VARCHAR(50),
    Item VARCHAR(100),
...
$stmt = $conn->prepare("INSERT INTO customer2 (OrderDate, Company, Owner, Item, Quantity, Weight, RequestForShipment, TrackingId, ShipmentSize, BoxCount, Specification, ChecklistQuantity) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
